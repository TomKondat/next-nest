...
router
  .route("/")
  .get(authControllers.restrictByRole("agent"), userControllers.getUsers);
...
router
  .route("/get-managed-properties")
  .get(
    authControllers.protect,
    authControllers.restrictByRole("agent"),
    userControllers.getManagedProperties
  );
router
  .route("/get-saved-properties")
  .get(
    authControllers.protect,
    authControllers.restrictByRole("buyer"),
    userControllers.getSavedProperties
  );

router
  .route("/delete-from-saved-properties/:propertyId")
  .delete(
    authControllers.protect,
    authControllers.restrictByRole("buyer"),
    userControllers.deleteFromSavedProperties
  );
